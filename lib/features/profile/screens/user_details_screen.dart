              ...
              ElevatedButton(
                onPressed: () async {
                  if (_key.currentState!.validate()) {
                    await PreferenceManager().setString(StorageKey.username, userNameController.value.text);
                    await PreferenceManager().setString(StorageKey.motivationQuote, motivationQuoteController.value.text);
